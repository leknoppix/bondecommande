...
<?php echo $this->Form->create('OrderformsProduct'); ?>
	<fieldset>
		<legend><?php echo __('Edit Orderforms Product'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('OrderformsProduct.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('OrderformsProduct.id'))); ?></li>

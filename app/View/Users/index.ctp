<div class="users index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('telephone_fixe'); ?></th>
			<th><?php echo $this->Paginator->sort('telephone_mobile'); ?></th>
			<th><?php echo $this->Paginator->sort('adresse_postale'); ?></th>
	...
	<tr>
		...
		<td><?php echo h($user['User']['adresse_postale']); ?>&nbsp;</td>
